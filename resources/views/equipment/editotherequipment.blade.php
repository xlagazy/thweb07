    ...
    <div class="ct_listuser">
        ...
        <div class="row" >
            <div class="col alert alert-primary" role="alert">
                <b>แก้ไขข้อมูล Other Equipment number : {{$equipments->ot_equipment_no}}</b>
            </div>
        </div>
        ...
        <div class="row border border-secondary rounded">
            ...
            <form action="{{URL::to('editotherequipment')}}" method="post" enctype="multipart/form-data" class="frmedt needs-validation ">   
                <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>" >
                <input type = "hidden" name = "ot_equipment_no" value = "{{$equipments->ot_equipment_no}}" >

                <div class="row">
                    <div class="col">
                        <label><b>Equipment Type</b></label>
                        <select name="equip_type" class="form-control" disabled>
                        <option disabled selected value>Choose...</option>
                        @foreach($equip_type as $equip_ties)
                            @if($equip_ties->ot_equip_type_id == $equipments->ot_equip_type_id)
                                <option value="{{$equip_ties->ot_equip_type_id}}" selected>{{$equip_ties->ot_equip_type_name}}</option>
                            @else
                                <option value="{{$equip_ties->ot_equip_type_id}}" disabled>{{$equip_ties->ot_equip_type_name}}</option>
                            @endif
                        @endforeach
                        </select>
                    ...
                    <div class="col">
                        ...
                        <input type="text" class="form-control" name="ot_equipment_name" value="{{$equipments->ot_equipment_name}}" placeholder="Equipment name" required>
                    ...
                    <div class="col">
                        ...
                        <select name="location" class="form-control border rounded selectpicker" data-live-search="true" required>
                            ...
                            @foreach($location as $locations)
                                @if($locations->locat_id == $equipments->location)
                                    <option value="{{$locations->locat_id}}" selected>{{$locations->locat_name}}</option>
                                @else
                ...
                <div class="row">
                    <div class="col">
                        <label><b>Tel</b></label>
                        <input type="number" class="form-control" name="tel_no" value="{{$equipments->tel_no}}" placeholder="Tel" maxlength="4" required>
                        <div class="invalid-feedback">Please input data</div>
                    </div>
