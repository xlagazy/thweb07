...
<div class="modal fade" id="addmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
   <div class="modal-dialog modal-dialog-scrollable modal-lg" role="document">
         ...
         <div class="modal-header">
            <h5 class="modal-title" id="exampleModalLongTitle">เพิ่ม Stock Material</h5>
            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
            <span aria-hidden="true">&times;</span>
            </button>
         </div>
         <div class="modal-body">
            <form action="{{URL::to('addstockmaterial')}}" method="post" enctype="multipart/form-data" class="frm needs-validation">   
               ...
               <div class="form-group">
                        ...
                        <input class="form-control" name="stock_material_qty" type="number" value="0" min="0" max="1000" step="1"/>
               </div>
