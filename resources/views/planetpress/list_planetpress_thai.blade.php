...
@section('contents')
    ...
    <div class="ct_listuser">
        ...
        <div>
            <a href="{{URL::to('listplanetpressthai')}}" class="text-decoration-none text-dark">
                <h1 style="margin-bottom:2%">Planet Press Printer <label class="text-danger">(THAI)</label></h1>
            </a>
        </div>
        ...
        <div>
            @include('planetpress.modal_add_planetpress_thai')
        </div>
        ...
        <div class="table-responsive">
            <table class="table table-hover table-bordered table-sm">
                ...
                @endif
                <form action="{{URL::to('listplanetpressthai/search')}}" method="get" class="form-inline" id="form" style="margin-right:auto;">
                    <thead>
                        <tr>
                            <th scope="col">No</th>
                ...
                @foreach($planet as $key => $data)
                    <tr>
                        ...
                        <td>
                            ...
                            Edit</a>  
                            <div>
                                @include('planetpress.modal_edit_planetpress_thai')
                            </div>                      
                        </td>
                        <td>
                            ...
                            Copy</a>  
                            <div>
                                @include('planetpress.modal_copy_planetpress_thai')
                            </div>                      
                        </td>
                        <td>
                            <a href="/deleteplanetpressthai/{{$data->ID}}" class="dlt_user text-danger">
