<div class="modal fade" id="copyprinter{{$data->ID}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" role="document">
        ...
        <div class="modal-body">
            <form action="{{URL::to('copyplanetpressthai')}}" method="post" enctype="multipart/form-data" class="frmedt needs-validation">   
