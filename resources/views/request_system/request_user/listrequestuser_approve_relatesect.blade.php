...
@section('contents')
    <div class="table-responsive">
        <div style="margin-bottom:2%">
            <a href="/listrequestuser">Request User</a> / Relate Section
        </div>
        ...
        <table class="table table-bordered table-sm">
            ...
            @endif
            <thead>
                <form action="{{URL::to('/listrequestuser/approve/relatesect/search')}}" method="get" class="form-inline" id="form" style="margin-right:auto;">
                    <tr>
                        ...
                        @for($i=0;$i<$countsect;$i++)
                            @if($arr_relate_sect[$i] == Cookie::get('section'))
                                <tr>
                                    ...
                                    <td class="text-center">
                                        @php
                                            App\Http\Controllers\RequestUserController::approveRequestUserRelateSect($data->no, Cookie::get('employee_no'), $i);
                                        @endphp
                                    </td>
                                </tr>
                            @endif
