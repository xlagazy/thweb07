<!-- Modal Detail -->
<div class="modal fade text-left" id="requestuserup" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
    <div class="modal-dialog modal-dialog modal-dialog-scrollable modal-lg" role="document">
        <div class="modal-content">
        <div class="modal-header" style="color:#000;">
            <h5 class="modal-title" id="exampleModalLongTitle">Update request user</h5>
        ...
        <div class="modal-body" style="color:#000;">
            <form action="/listrequestuser/receieved/update" method="post" enctype="multipart/form-data" class="frm">
                ...
                <div id="hidden_button" class="text-right">
                    ...
                    <button type="button" name="btn2" class="btn btn-success updaterequestuser">Update</button>
                </div>
            </form>

            <script type="text/javascript" src="{{asset('scripts/updaterequest_user.js')}}"></script>
