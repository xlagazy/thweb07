    ...
    <div class="ct_listuser">
        ...
        <table class="table table-hover table-dark">
            ...
            @foreach($vendor as $vendors)
                <tr>
                    <td scope="row" >{{$no}}</td>
                    <td scope="row" >{{$vendors->vendor_name}}</td>
                    <td>
                        <a href="" data-toggle="modal" data-target="#edtmodal{{$vendors->vendor_id}}">
                        <i class="bi bi-pencil-square"></i>
                        Edit</a>

                        <!-- Modal edit -->
                        <div class="modal fade" id="edtmodal{{$vendors->vendor_id}}" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md" role="document">
                                <div class="modal-content">
                                <div class="modal-header" style="color:#000;">
                                    <h5 class="modal-title" id="exampleModalLongTitle">แก้ไข Vendor</h5>
                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                    <span aria-hidden="true">&times;</span>
                                    </button>
                                </div>
                                <div class="modal-body" style="color:#000;">
                                    <form action="{{URL::to('editvendor')}}" method="post" enctype="multipart/form-data" class="frmedt needs-validation">   
                                        ...
                                        <div class="row">
                                            <div class="col">
                                                ...
                                                <input type="text" class="form-control" name="vendor_name" placeholder="Vendor name" value="{{$vendors->vendor_name}}" required>
                    ...
                    <td>
                        <a href="deletevendor/{{$vendors->vendor_id}}" class="dlt_user" style="color:red;">
        ...
        <div class="modal fade" id="addmodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            <div class="modal-dialog modal-dialog-centered modal-dialog-scrollable modal-md" role="document">
                ...
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLongTitle">เพิ่ม Vendor</h5>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <div class="modal-body">
                    <form action="{{URL::to('addvendor')}}" method="post" enctype="multipart/form-data" class="frm needs-validation">   
                        <input type = "hidden" name = "_token" value = "<?php echo csrf_token(); ?>" >
